...
Future<Prediction> fetchPrediction(List controllers) async {
  ...
  final response = await http.post(
      Uri.parse('https://ballebazzi.onrender.com/predict'),
      body: data
  );
          ...
          children:[
            ...
            Row(
              children: [
                const Padding(
                  ...
                  child: Text("Rainfall Values",
                    style: TextStyle(fontWeight: FontWeight.w900, fontSize: 30),),
                ),
                // Padding(
                //   padding: const EdgeInsets.symmetric(horizontal: 10),
                //   child: Image.asset("assets/rain.png", width: 65,),
                // ),
              ],
            ),
            ...
            Padding(
              ...
              child: DropdownButtonFormField(
                  ...
                  decoration: const InputDecoration(
                    label: Text("Choose Machine Learning Model"),
                  ),
                  ...
                  onChanged: (val){
                    setState(() {
                      ...
                      else if(_selectedModel==_models[3]){
                        model='XGB';
                      }
                    });
                  }
            ...
            if(!showCustom) Row(
              mainAxisAlignment: MainAxisAlignment.center,
              children: [
                Text("Ground Report : ", style : TextStyle(fontSize: 20)),
            ...
            if(showPrediction) Row(
              mainAxisAlignment: MainAxisAlignment.center,
              children: [
                const Center(child: Text("Flood Occurance: ",
